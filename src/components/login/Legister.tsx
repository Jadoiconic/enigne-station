...
function Legister() {
    ...
    const handleRegister = async (e: React.FormEvent) => {
            ...
            try {
                ...
                const response = await fetch('/api/users', {
                    ...
                    body: JSON.stringify({ name:names, email, password, type: 'register' }),
                });
  ...
  return (
      <section className="rounded-sm border h-screen border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
